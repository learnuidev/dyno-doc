export const metadata = {
  title: 'Tables',
  description:
    'On this page, we’ll dive into the different table endpoints you can use to manage tables programmatically.',
}

# Tables

As the name suggests, tables are a core part of Dyno — the very reason Dyno exists is so you can perform many operations on tables. On this page, we'll dive into the different table operations supported by Dyno. We'll look at how to query, create, clone, join and delete tables {{ className: 'lead' }}

## The Table Model

The table model contains all the information about your table, such as their language, roman and english translations. It also contains additional information like initial, final, tone_level if the component is of tonal language (ex: Chinese)
